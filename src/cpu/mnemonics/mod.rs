...
impl Mnemonics {
    ...
    pub fn resolve_mnemonic_from_opcode(&self, opcode: u8) -> Box<Mnemonic> {
        return match opcode {
            ...
            0x09 | 0x05 | 0x15 | 0x0D | 0x1D | 0x19 | 0x01 | 0x11 => Box::new(Ora::new(opcode)),
            ...
            0x85 | 0x95 | 0x8D | 0x9D | 0x99 | 0x81 | 0x91 => Box::new(Sta::new(opcode)),
            0x86 | 0x96 | 0x8E => Box::new(Stx::new(opcode)),
            0x84 | 0x94 | 0x8C => Box::new(Sty::new(opcode)),
            0xAA => Box::new(Tax::new(opcode)),
            0xA8 => Box::new(Tay::new(opcode)),
            0xBA => Box::new(Tsx::new(opcode)),
            0x8A => Box::new(Txa::new(opcode)),
            0x9A => Box::new(Txs::new(opcode)),
            0x98 => Box::new(Tya::new(opcode)),
